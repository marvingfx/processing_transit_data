...
* Download the latest Kafka binary version [here](https://kafka.apache.org/downloads) and extract in `kafka/` (this project used version 2.11-2.4.1)
* Download and install the latest Spark version [here](https://spark.apache.org/downloads.html)
